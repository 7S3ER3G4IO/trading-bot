"""
signals.py — Fonctions de signal optimizer_v6 (BK, MR, TF)
"""
...
def sig_bk(row, rh, rl, pr):
    ...
    if rng/c*100<0.02 or rng/c*100>10: return "HOLD",0
...
def sig_tf(row, rh, rl, pr):
    """Trend Following: EMA crossover + ADX + MACD confirmation."""
